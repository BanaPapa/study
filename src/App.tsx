    ...
    <div className="login-page">
      <div className="login-box">
        ...
        <div className="login-btns">
          <button className="login-btn google" onClick={() => signIn("google", { redirectTo: window.location.href })}>
          ...
          <button className="login-btn github" onClick={() => signIn("github", { redirectTo: window.location.href })}>
          ...
          <button className="login-btn kakao" onClick={() => signIn("kakao", { redirectTo: window.location.href })}>
